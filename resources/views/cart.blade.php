                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="qty-control position-relative">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('cart.qty.decrease', ['rowId' => $cartItem->rowId]) }}">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="qty-control__reduce">-</div>
                                                </form>
                                                <form method="POST"
                                                    action="{{ route('cart.qty.increase', ['rowId' => $cartItem->rowId]) }}">
                                                    @csrf
                                                    @method('PUT')
                                        ...
                                        <td>
                                            <form method="POST"
                                                action="{{ route('cart.item.remove', ['rowId' => $cartItem->rowId]) }}">
                                                @csrf
                                                @method('DELETE')
